    ...
    <div className="min-h-screen bg-gradient-to-b from-[#1f1b2e] to-[#2b2260] text-white flex flex-col">
      ...
      <nav className="flex justify-between items-center px-8 py-6">
        ...
        <div className="flex items-center space-x-6">
          ...
          <a href="/login" className="font-semibold hover:text-purple-400">Sign In</a>
          <a href="/login" className="bg-purple-500 hover:bg-purple-600 px-4 py-2 rounded-lg font-semibold">
            Get Started
          </a>
        </div>
      </nav>
